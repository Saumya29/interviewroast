		...
		<main className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
			...
			<div className="max-w-4xl mx-auto px-6 py-20 text-center">
				<h1 className="text-5xl md:text-6xl font-bold mb-6">
					Practice the questions they&apos;re <span className="text-red-500">afraid</span> to ask
					you
				</h1>
				<p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
					Paste any job description. Get 10 brutal interview questions tailored to that role. Answer
					them. Get roasted on what you got wrong.
				</p>
				<Link href="/start">
				...
				<div className="grid md:grid-cols-3 gap-8">
					...
					<div className="text-center">
						...
						<p className="text-gray-400">
							Brutally honest feedback on every answer + readiness score
						</p>
					</div>
				</div>
			</div>
			...
			<div className="max-w-4xl mx-auto px-6 py-16 border-t border-gray-800">
				...
				<div className="space-y-4 text-gray-300">
					<p className="p-4 bg-gray-800/50 rounded-lg">
						&quot;Tell me about a time you had to push back on a product decision. What
						happened?&quot;
					</p>
					<p className="p-4 bg-gray-800/50 rounded-lg">

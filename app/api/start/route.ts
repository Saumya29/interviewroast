...
Make questions progressively harder. The last 3 should be the toughest.`;
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are a senior hiring manager who has conducted hundreds of interviews. Generate tough, specific interview questions. Respond only with valid JSON.",
        },
        {
          role: "user",
          content: prompt,
